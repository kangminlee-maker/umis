...
.cursorrules 개선:
  ...
  After:
    # Agent names from agent_names.yaml
    # Load and apply dynamically
    
    agent_name_binding:
      source: agent_names.yaml
      mapping:
...
.cursorrules (바인딩):
  ...
  agent_name_source: agent_names.yaml
