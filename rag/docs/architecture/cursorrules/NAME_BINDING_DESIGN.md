...
_meta:
  agent_names_source: agent_names.yaml
  note: "name 필드는 agent_names.yaml 값 사용 (동적 바인딩)"
...
_agent_name_binding:
  description: "Agent name은 agent_names.yaml 동적 바인딩"
  mapping:
...
agents:
  - id: Observer
    default_name: "Albert"  # 기본값 (agent_names.yaml 없을 때)
```
...
# ========================================
# Agent Names: agent_names.yaml에서 커스터마이징
# ========================================
# 
# 기본값: Albert, Steve, Bill, Rachel, Stewart
# 커스터마이징: agent_names.yaml 수정
# 
# AI 주의: name 필드는 agent_names.yaml 우선!
# ========================================
...
동작:
  AI:
    1. 주석 읽기
       "name 필드는 agent_names.yaml 우선!"
    
    2. agent_names.yaml 자동 읽기
       observer: Jane
...
umis_guidelines.yaml 수정:
  ...
  최상단 주석:
    # Agent Names: agent_names.yaml 우선!
...
.cursorrules:
  이미 반영됨:
    # name: Default name → agent_names.yaml로 커스터마이징
