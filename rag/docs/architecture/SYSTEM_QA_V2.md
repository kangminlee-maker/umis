...
테스트 항목:
  ...
  3. Agent 커스터마이징
     수정: agent_names.yaml (explorer: Alex)
     테스트: "@Alex" 작동?
     상태: (테스트 필요)
...
Critical Path:
  agent_names.yaml → .cursorrules → 매핑
