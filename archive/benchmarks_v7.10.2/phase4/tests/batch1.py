#!/usr/bin/env python3
"""
Phase 4 Batch 1: 최우선 후보 모델 테스트
- o3-mini-2025-01-31 (가장 유력)
- o4-mini-2025-04-16 (가장 유력)
- o3-2025-04-16 (프리미엄)
...
# phase4 common 모듈에서 공통 함수 import
...
def save_partial_results(all_results, scenarios, test_config, error_info=None):
    ...
    output_file = f"phase4_batch1_{status.lower()}_{timestamp}.json"
    
    data = {
        'metadata': {
            'timestamp': datetime.now().isoformat(),
            'batch': 'Batch 1 - 최우선 후보',
            'status': status,
...
def run_batch1_test():
    """Batch 1 테스트 실행"""
    print("=" * 120)
    print("Phase 4 Batch 1 - 최우선 후보 모델 테스트")
    print("=" * 120)
    print()
    ...
    # Batch 1: 최우선 후보 3개
    test_config = [
        {'model': 'o3-mini-2025-01-31', 'effort': 'high', 'tier': 'Batch 1'},
        {'model': 'o4-mini-2025-04-16', 'effort': 'high', 'tier': 'Batch 1'},
        {'model': 'o3-2025-04-16', 'effort': 'high', 'tier': 'Batch 1'},
    ]
    ...
    print("\n" + "=" * 120)
    if error_occurred:
        print(f"⚠️  Batch 1 부분 결과 ({len(all_results)}개 테스트 완료)")
    else:
        print("🏆 Batch 1 최종 순위 (3개 문제 평균)")
    print("=" * 120)
    print()
