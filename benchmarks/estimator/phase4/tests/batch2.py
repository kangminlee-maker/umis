...
def save_partial_results(all_results, scenarios, test_config, error_info=None):
    ...
    output_file = f"phase4_batch2_{status.lower()}_{timestamp}.json"
...
def run_batch2_test():
    """Batch 2 테스트 실행"""
    print("=" * 120)
    print("Phase 4 Batch 2 - 실용 모델 테스트")
    print("=" * 120)
    print()
    ...
    # Batch 2: 실용 모델 5개
    test_config = [
        {'model': 'o1', 'effort': 'high', 'tier': 'Batch 2'},
        {'model': 'o1-2024-12-17', 'effort': 'high', 'tier': 'Batch 2'},
        {'model': 'gpt-4.1', 'effort': 'high', 'tier': 'Batch 2'},
        {'model': 'gpt-4.1-mini', 'effort': 'high', 'tier': 'Batch 2'},
        {'model': 'o3-mini', 'effort': 'high', 'tier': 'Batch 2'},
    ]
    ...
    print("\n" + "=" * 120)
    if error_occurred:
        print(f"⚠️  Batch 2 부분 결과 ({len(all_results)}개 테스트 완료)")
    else:
        print("🏆 Batch 2 최종 순위 (3개 문제 평균)")
    print("=" * 120)
    print()
