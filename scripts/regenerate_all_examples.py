...
try:
    ...
    fp = gen.generate(
        ...
        assumptions=[
            ...
            {'id': 'FILTER_PIANO', 'category': '제품', 'description': '피아노', 'value': 0.25, 'unit': '%', 'data_type': '추정치', 'source': 'EST_001', 'confidence': 'Medium', 'estimation_logic': '악기 판매 데이터 기반', 'base_data': '전체 악기 중 피아노', 'calculation': '판매 비중 25%'},
            {'id': 'SEG1_CUSTOMERS', 'category': '세그먼트1', 'description': '타겟', 'value': 100000, 'unit': '명', 'data_type': '추정치', 'source': 'EST_002', 'confidence': 'Medium', 'estimation_logic': '시장 조사', 'base_data': '인구 통계', 'calculation': '타겟 고객 산정'},
            {'id': 'SEG1_RATE', 'category': '세그먼트1', 'description': '전환율', 'value': 0.2, 'unit': '%', 'data_type': '추정치', 'source': 'EST_003', 'confidence': 'Medium', 'estimation_logic': '업계 평균', 'base_data': '유사 서비스', 'calculation': '전환율 20%'},
            ...
            {'id': 'PROXY_CORR', 'category': 'Proxy', 'description': '상관', 'value': 0.3, 'unit': '', 'data_type': '추정치', 'source': 'EST_004', 'confidence': 'Low', 'estimation_logic': '시장 상관성', 'base_data': '유사 시장 비교', 'calculation': '상관계수 0.3'},
            {'id': 'PROXY_APP', 'category': 'Proxy', 'description': '적용', 'value': 0.5, 'unit': '%', 'data_type': '추정치', 'source': 'EST_005', 'confidence': 'Medium', 'estimation_logic': '적용 가능성', 'base_data': '시장 특성', 'calculation': '50% 적용'},
            {'id': 'COMP1_REV', 'category': '경쟁사1', 'description': '매출', 'value': 10_000_000_000, 'unit': '원', 'data_type': '직접데이터', 'source': 'SRC_006', 'confidence': 'High'},
            {'id': 'COMP1_SHARE', 'category': '경쟁사1', 'description': '점유율', 'value': 0.4, 'unit': '%', 'data_type': '추정치', 'source': 'EST_006', 'confidence': 'Medium', 'estimation_logic': '시장 분석', 'base_data': '매출 데이터', 'calculation': '점유율 40%'},
        ],
